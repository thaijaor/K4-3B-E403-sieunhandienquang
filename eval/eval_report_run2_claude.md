...
- Chạy lúc 2026-09-18 19:36, agent `http://127.0.0.1:8001`, run `ada961`.
- Model gọi thật; mỗi case một learner riêng. Kết quả thô: `eval/results_latest.json`.
- Điểm chấm tay: `eval/claude_ratings.json` — Chấm bởi Claude (LLM-as-judge) trên câu trả lời lượt 2 (results_run2.json) — KHÔNG phải người chấm. Dùng để tham khảo / đối chiếu với human_ratings.json của Thái và Cường..
