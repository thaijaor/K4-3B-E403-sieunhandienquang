...
PERSONA_RULES = (
    ...
    "có thể nói cơ chế hoặc code. Nội dung sự thật và citation không đổi theo Persona."
)
...
MEMORY_RULES = (
    ...
    "câu trả lời, không gọi tool. Không ghi điều nhạy cảm. Học viên bảo quên thì gọi forget. "
...
def grounded_in(item, learner_text):
    ...
    return bool(_words(value) & _words(learner_text))
